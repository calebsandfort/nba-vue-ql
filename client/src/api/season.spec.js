...
describe("seasons", () => {
  ...
  it("returns a list of seasons", async () => {
    ...
    const requestVariables = seasonApi.getRequestVariables();
    requestVariables.includeTeamSeasons = true;
    requestVariables.teamId = 1

    const result = await seasonApi.getAll(client, requestVariables);
